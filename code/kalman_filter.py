...
# For simplicity, I only implement the 1D case
...
# parameters for generating samples (the same as in AR(1) plus noise)
...
### calculate loglikelihood for specified parameters using kalman filter
...
## using kalman filter method to find parameters with maximum likelihood
# kalman_filter = Kalman_Filter(V_epi=sigma_epsilon_square_0, mu0=0, V0=1, A=1, b=1, V=1)
